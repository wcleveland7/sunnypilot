...
def create_acc_buttons_control(packer, bus, gra_stock_values, counter, cancel=False, resume=False, accel_cruise=False, decel_cruise=False, resume_cruise=False, set_cruise=False):
